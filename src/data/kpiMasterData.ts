...
export const KPI_MASTER_DATA: KPIRecord[] = [
  ...
  {
    id: "KPI-158",
    metric: "New Leads by Trade & Industry Vertical",
    function: "Lead & Contact Management",
    object: "Lead",
    dataSources: "Salesforce + Marketo / HubSpot",
    dimensions: "Trade / Industry, Lead Source, Region, Time",
    type: "Leading",
    bestVisualization: "Sorted bar chart",
    analysisPurpose: "Measures incoming new lead flow grouped by trade and contractor vertical (HVAC, Electrical, Plumbing, Roofing, General Contracting) and source channel to assess market penetration."
  },
  {
    id: "KPI-159",
    metric: "Speed to Lead & First Contact SLA Adherence",
    function: "Lead & Contact Management",
    object: "Lead + Activity",
    dataSources: "Salesforce + Marketo / HubSpot",
    dimensions: "Trade, Rep, Lead Source, Time Bucket",
    type: "Leading",
    bestVisualization: "Box plot",
    analysisPurpose: "Calculates the elapsed minutes between lead creation and first sales touch, evaluating compliance against the 15-minute SLA target across trades."
  },
  {
    id: "KPI-160",
    metric: "Lead to SQL to Closed Won Funnel Conversion Rate",
    function: "GTM Analysis",
    object: "Lead + Opportunity",
    dataSources: "Salesforce + Marketo / HubSpot",
    dimensions: "Funnel Stage, Trade, Channel, Segment, Time",
    type: "Lagging",
    bestVisualization: "Funnel chart",
    analysisPurpose: "Measures end-to-end stage progression and conversion waterfall from raw lead ingress to MQL, SQL, active Opportunity, and Closed Won booking."
  },
  {
    id: "KPI-161",
    metric: "Funnel Stage Transition Velocity & Dwell Time",
    function: "GTM Analysis",
    object: "Opportunity History + Lead",
    dataSources: "Salesforce",
    dimensions: "Stage, Trade, Segment, Rep",
    type: "Leading",
    bestVisualization: "Line chart",
    analysisPurpose: "Measures the average days opportunities spend in each pipeline stage before advancing or dropping out to pinpoint funnel bottlenecks."
  },
  {
    id: "KPI-162",
    metric: "Cost Per Lead (CPL) by Campaign and Acquisition Channel",
    function: "Cross-Lifecycle & Strategic Finance Analysis",
    object: "Campaign + Lead + Spend",
    dataSources: "Salesforce + Marketo / HubSpot + Internal DW — Finance PO",
    dimensions: "Campaign, Channel, Trade, Period",
    type: "Leading",
    bestVisualization: "Sorted bar chart",
    analysisPurpose: "Calculates acquisition cost per newly generated lead (Total Campaign Spend / Total Leads Acquired) across marketing channels and trades."
  },
  {
    id: "KPI-163",
    metric: "Customer Acquisition Cost (CAC) - Blended & Paid",
    function: "Cross-Lifecycle & Strategic Finance Analysis",
    object: "Campaign + Opportunity + Spend",
    dataSources: "Salesforce + Marketo / HubSpot + Internal DW — Finance PO",
    dimensions: "Channel, Segment, Trade, Quarter",
    type: "Lagging",
    bestVisualization: "KPI counter + benchmark bar",
    analysisPurpose: "Calculates fully loaded sales and marketing acquisition cost per new closed-won customer (Total S&M Spend / Won Customer Logos)."
  },
  {
    id: "KPI-164",
    metric: "Campaign Return on Investment (ROI) & ROAS",
    function: "Cross-Lifecycle & Strategic Finance Analysis",
    object: "Campaign + Opportunity + Spend",
    dataSources: "Salesforce + Marketo / HubSpot + Internal DW — Finance PO",
    dimensions: "Campaign, Channel, Segment, Year",
    type: "Lagging",
    bestVisualization: "Bubble chart",
    analysisPurpose: "Calculates campaign net return on investment percentage ((Attributed Sourced ARR - Campaign Cost) / Campaign Cost × 100%) across GTM motions."
  },
  {
    id: "KPI-165",
    metric: "Sales Pipeline Velocity ($/day)",
    function: "Pipeline & Opportunity Management",
    object: "Opportunity",
    dataSources: "Salesforce",
    dimensions: "Rep, Region, Trade, Segment",
    type: "Leading",
    bestVisualization: "Bubble chart",
    analysisPurpose: "Measures daily pipeline revenue generation velocity using the four core sales levers: (# Open Opportunities × Win Rate % × Average Contract Value) / Sales Cycle Days."
  },
  {
    id: "KPI-166",
    metric: "Net Revenue Retention (NRR) and GRR Retention Curve",
    function: "Account Management",
    object: "Subscription + Invoice",
    dataSources: "Salesforce + Internal DW — Finance PO",
    dimensions: "Signup Cohort, Segment, Trade, Expansion Type",
    type: "Lagging",
    bestVisualization: "Cohort heatmap (pivot + color scale)",
    analysisPurpose: "Measures recurring revenue expansion, contraction, and churn across customer cohorts ((Starting ARR + Expansion - Contraction - Churn) / Starting ARR × 100%)."
  }
];
