...
export const HandshakeSvg: React.FC<{ className?: string }> = ({ className = "h-24 w-24" }) => {
  return (
    ...
    >
      ...
      {/* 
        COZY CRAYON COLOR FILLS (Warriors Blue Circle Base)
      */}
      <circle
        cx="100"
        cy="60"
      ...
      */}
      ...
      {/* 
        GOLDEN BRAND RING INSIDE (Salesforce-yellow/GSW-gold match)
      */}
      <circle
        cx="100"
        cy="60"
      ...
      {/* 
        THE SUSPENSION BRIDGE (Double ink outline, filled with warm gold)
      */}
      ...
      <g stroke="#18181b" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {/* Little triangle cap */}
        <path d="M 83 41 L 88 35 L 93 41 Z" fill="#ffc72c" />
      </g>
      ...
      <g stroke="#ffc72c" strokeWidth="1.2" opacity="0.9" strokeLinecap="round">
      ...
      {/* 
        THE ICONIC NUMBER "30" (Stephen Curry Tribute)
      */}
      <text
        x="105"
        y="55"
      ...
      <text
        x="104.5"
        y="54.5"
        className="font-hand font-black text-xl select-none fill-[#ffc72c]"
        style={{ transform: "rotate(-2deg)" }}
      >
        30
      </text>
      ...
      */}
      ...
      <text className="font-hand font-black text-[9px] tracking-[0.25em] select-none uppercase">
        <textPath href="#gsw-top-path" startOffset="50%" textAnchor="middle" className="fill-[#ffc72c]">GOLDEN STATE</textPath>
      </text>
      ...
      <text className="font-hand font-black text-[10px] tracking-[0.3em] select-none uppercase">
        <textPath href="#gsw-bottom-path" startOffset="50%" textAnchor="middle" className="fill-[#ffc72c]">WARRIORS</textPath>
      </text>
      ...
      */}
      ...
      <path d="M 42 96 L 44 92 L 46 96 L 50 98 L 46 100 L 44 104 L 42 100 L 38 98 Z" fill="#ffc72c" stroke="#18181b" strokeWidth="1" />
    </svg>
  );
};
...
export const ArchitectureFlowSvg: React.FC<{ className?: string }> = ({ className = "h-24 w-24" }) => {
  return (
    ...
    >
      {/* 
        COLOR BACKGROUNDS WITH INNER COLOURED-PENCIL SCRIBBLE SHADING PATTERNS
      */}

      {/* Top Source Node Box: Yellow background & crayon shading */}
      <rect x="65" y="5" width="26" height="18" rx="4" fill="#fef08a" opacity="0.8" />
      ...
      <polygon points="50,45 62,55 50,65 38,55" fill="#fed7aa" opacity="0.8" />
      ...
      <rect x="150" y="12" width="38" height="85" rx="5" fill="#bfdbfe" opacity="0.8" />
      <g stroke="#2563eb" strokeWidth="1.1" opacity="0.5" strokeLinecap="round">
      ...
      <rect x="155" y="20" width="28" height="15" rx="2" fill="#fafafa" />
      <rect x="155" y="45" width="28" height="15" rx="2" fill="#fafafa" />
      <rect x="155" y="70" width="28" height="15" rx="2" fill="#fafafa" />


      {/* 
        DOUBLE INK-MARKER OUTLINES WITH SHAKY ARTIFACTS
      */}
    ...
    >
      ...
      */}
      ...
      <path
        ...
        opacity="0.8"
      />
      <g stroke="#dc2626" strokeWidth="1.1" opacity="0.55" strokeLinecap="round">
      ...
      <polygon points="95,35 110,41 95,47" fill="#bbf7d0" opacity="0.85" />
      <g stroke="#16a34a" strokeWidth="1" opacity="0.55" strokeLinecap="round">
      ...
      <polygon points="165,18 185,25 165,32" fill="#fca5a5" opacity="0.85" />
      <g stroke="#dc2626" strokeWidth="1.1" opacity="0.55" strokeLinecap="round">
      ...
      <g transform="translate(133, 70) rotate(-15)">
        ...
        <rect x="10" y="10" width="34" height="16" rx="3" fill="#fafafa" />
        ...
        <rect x="22" y="9.5" width="8" height="17" fill="#fca5a5" />
        ...
        <path d="M 26 26.5 L 22 36 L 26 34 L 30 36 Z" fill="#fca5a5" />
      ...
      */}
      ...
      {/* The winding path road: thick marker dotted lines */}
      <path
      ...
      {/* Checkpoint flag pole and flag outlines */}
      ...
      {/* Goal flag pole and flag outlines */}
      ...
      {/* Graduation Scroll / Diploma in the corner dual-outlined */}
      <g transform="translate(133, 70) rotate(-15)">
  ...
  return (
    <div className={`relative flex flex-col items-center justify-center ${className}`}>
      ...
      >
        ...
        {/* Bare Feet */}
        <path d="M 43.5 119 Q 41.5 125 43 126 C 44.5 127, 46.5 126, 45.5 121" fill="none" stroke="#18181b" strokeWidth="2.2" strokeLinecap="round" />
        <path d="M 56.5 119 Q 58.5 125 57 126 C 55.5 127, 53.5 126, 54.5 121" fill="none" stroke="#18181b" strokeWidth="2.2" strokeLinecap="round" />
        ...
        <g>
          {/* Balloon Crayon Fill: Base Sky Blue with slightly uneven opacity */}
          <path
          ...
          <g stroke="#0284c7" strokeWidth="1.2" opacity="0.65" strokeLinecap="round">
            <path d="M 71 28 Q 79 38 87 28" fill="none" />
            <path d="M 69 35 Q 79 45 89 35" fill="none" />
            <path d="M 73 21 Q 79 29 85 21" fill="none" />
          </g>

          {/* Whimsical shine highlight */}
          <path
            d="M 86 24 Q 89.5 30 88 36"
            fill="none"
            stroke="#e0f2fe"
            strokeWidth="2.5"
            strokeLinecap="round"
        ...
        {/* Oversized Trench Coat Body - Colored in warm crayon camel/tan! */}
        <path
        ...
        <g stroke="#9a3412" strokeWidth="1" strokeLinecap="round" opacity="0.3">
        ...
        <path d="M 34 78 H 40.5 V 84 H 34 Z" fill="#38bdf8" stroke="#18181b" strokeWidth="2" strokeLinejoin="round" />
        ...
        {/* Baggy Oversized Sleeves - Colored in warm crayon camel/tan! */}
        {/* Left Sleeve */}
        <path
        ...
        {/* High pointed Lapels with yellow crayon contrast! */}
        {/* Left pointed lapel block */}
        <path d="M 41 64 L 34 74 L 46 78 Z" fill="#fde047" stroke="#18181b" strokeWidth="2.2" strokeLinejoin="round" />
        <line x1="41" y1="64" x2="46" y2="78" stroke="#18181b" strokeWidth="1.5" />

        {/* Right pointed lapel block */}
        <path d="M 59 64 L 66 74 L 54 78 Z" fill="#fde047" stroke="#18181b" strokeWidth="2.2" strokeLinejoin="round" />
        ...
        {/* Top Hat (tall and slightly tilted) */}
